...
class Tyrannosaurus extends Dinosaur {
  constructor(tyrannosaurusOptions) {
    super(tyrannosaurusOptions);
  }
  roar() {
...
class Stegosaurus extends Dinosaur {
  constructor(stegosaurusOptions) {
    super(stegosaurusOptions);
  }
}
class Velociraptor extends Dinosaur {
  constructor(velociraptorOptions) {
    super(velociraptorOptions);
  }
}
...
zooAnimals.forEach(animal => {
  const animalName = `Name: ${animal.animal_name}, Scientific: ${
...
zooAnimals.filter(animal => {
  return animal.population < 5 && largerPopulation.push(animal);
});
